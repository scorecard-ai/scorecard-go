...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Testsets.Get(context.Background(), "246")
	if userAgent != fmt.Sprintf("Scorecard/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Testsets.Get(context.Background(), "246")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Testsets.Get(cancelCtx, "246")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Testsets.Get(deadlineCtx, "246")
		if err == nil {
